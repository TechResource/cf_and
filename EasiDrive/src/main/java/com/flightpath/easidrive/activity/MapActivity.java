...
public class MapActivity extends EDBaseActivity implements MapCallbacks, HeaderFragment.HeaderCallback, DrawerMenuView.MenuCallbacks,
    ...
    public void onStopTrip() {
        tripStatusHelper.setTripStatus(TripObject.TripStatus.TRIP_STOPPED, locationHandler.getLocation(), 0);
    }
