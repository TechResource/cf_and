...
import com.flightpath.easidrive.EasiDriveApplication;
...
public class InspectionActivity extends EDBaseActivity implements InspectionModuleInterfaces.InspectionListener {
    ...
    private String readRawJson(){
        InputStream is = getResources().openRawResource(R.raw.inspection);
