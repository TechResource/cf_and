...
public class DateWidget extends FrameLayout implements InspectionWidgetInterface<InputObject> {
    ...
    public DateWidget(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void createDialogWithDateAndTimePicker() {
        ...
        dp.init(c.get(Calendar.YEAR), c.get(Calendar.MONTH), c.get(Calendar.DAY_OF_MONTH), new DatePicker.OnDateChangedListener() {
            ...
            public void onDateChanged(DatePicker view, int year, int monthOfYear, int dayOfMonth) {
                ...
                DateWidget.this.month = monthOfYear;
